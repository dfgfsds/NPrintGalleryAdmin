...
import { getAllProductOptionsApi, getAllProductVariantSizeApi, getProductApi } from '../../Api-Service/Apis';
...
export default function Products() {
  ...
  const filteredProducts: Product[] = data?.data?.products?.filter((product: Product) => {
